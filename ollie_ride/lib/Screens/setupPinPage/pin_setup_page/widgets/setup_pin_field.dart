...
class SetupPinField extends StatefulWidget {
  const SetupPinField({Key? key}) : super(key: key);

  @override
  _SetupPinFieldState createState() => _SetupPinFieldState();
}

class _SetupPinFieldState extends State<SetupPinField> {
  late bool _showPin;
        ...
        children: [
          ...
          Padding(
            ...
            child: PinPut(
              ...
              onChanged: (val) {
                val = _pinController.text;
                Provider.of<PinProvider>(context, listen: false).pin = val;
              },
